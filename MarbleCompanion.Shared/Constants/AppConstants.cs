...
public static class AppConstants
{
    ...
    public const string ErrorRed = "#D32F2F";

    // Habits
    public const int MaxActiveHabits = 10;

    // Feed
    public const int FeedExpiryDays = 7;

    // Streaks
    public const int StreakFreezeIntervalDays = 14;
    ...
    // Carbon
    public const string CO2eUnit = "kgCO2e";
}
